...
static std::tuple<ELFKind, uint16_t, uint8_t> parseEmulation(Ctx &ctx,
  ...
  std::pair<ELFKind, uint16_t> ret =
      StringSwitch<std::pair<ELFKind, uint16_t>>(s)
          ...
          .Case("elf64bedrock", {ELF64LEKind, EM_BEDROCK})
...
static bool getIsRela(Ctx &ctx, opt::InputArgList &args) {
  ...
  bool rela = is_contained(
      {EM_AARCH64, EM_AMDGPU, EM_BEDROCK, EM_HEXAGON, EM_LOONGARCH, EM_PPC,
       EM_PPC64, EM_RISCV, EM_S390, EM_X86_64},
      ctx.arg.emachine);
