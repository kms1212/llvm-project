...
typedef enum __bedrock_control_register {
  ...
  __BEDROCK_CR_UPC = 0x0108,
  __BEDROCK_CR_USP = 0x0109,
  __BEDROCK_CR_UCS = 0x010A,
  __BEDROCK_CR_UDS = 0x010B,
  __BEDROCK_CR_USS = 0x010C,
  __BEDROCK_CR_UCTL = 0x010D,
  __BEDROCK_CR_UINFO = 0x010E,
