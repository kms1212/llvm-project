...
_Static_assert(__BEDROCK_CR_UPC == 0x0108, "");
_Static_assert(__BEDROCK_CR_USP == 0x0109, "");
_Static_assert(__BEDROCK_CR_UCS == 0x010A, "");
_Static_assert(__BEDROCK_CR_UDS == 0x010B, "");
_Static_assert(__BEDROCK_CR_USS == 0x010C, "");
_Static_assert(__BEDROCK_CR_UCTL == 0x010D, "");
_Static_assert(__BEDROCK_CR_UINFO == 0x010E, "");
