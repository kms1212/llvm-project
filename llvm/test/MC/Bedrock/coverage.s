...
; CHECK-ENCODING: encoding: [0xcf,0xc3,0x58,0xf4,0x92,0x23]
...
encinst [r2]
; CHECK-INST: encinst	[r2]
; CHECK-ENCODING: encoding: [0xc7,0xef,0x46,0x12]
...
; CHECK-ENCODING: encoding: [0xc7,0xef,0x40,0x91]
...
; CHECK-ENCODING: encoding: [0xcb,0xf1,0x07,0x88,0x12]

moveq.l [r2], r1
; CHECK-INST: moveq.l	[r2], r1
; CHECK-ENCODING: encoding: [0xcb,0xf1,0x25,0x08,0x12]

ijt r1, r2, [r3]
; CHECK-INST: ijt	r1, r2, [r3]
; CHECK-ENCODING: encoding: [0xcb,0xf1,0x40,0x48,0x13]

ijne r1, r2, [r3]
; CHECK-INST: ijne	r1, r2, [r3]
; CHECK-ENCODING: encoding: [0xcb,0xf1,0x4c,0x48,0x13]

bndsii.q r1, [r2], r3
; CHECK-INST: bndsii.q	r1, [r2], r3
; CHECK-ENCODING: encoding: [0xcb,0xf0,0xb0,0x26,0x12]

bnduxx.l r1, [r2], r3
; CHECK-INST: bnduxx.l	r1, [r2], r3
; CHECK-ENCODING: encoding: [0xcb,0xf0,0xae,0x26,0x12]

divmodu.q [r2], r1, r3
; CHECK-INST: divmodu.q	[r2], r1, r3
; CHECK-ENCODING: encoding: [0xcb,0xf0,0xf0,0x98,0x12]

divmods.l [r2], r1, r3
; CHECK-INST: divmods.l	[r2], r1, r3
; CHECK-ENCODING: encoding: [0xcb,0xf0,0xe8,0x98,0x12]

fetchadd.q/relaxed r1, [r2]
; CHECK-INST: fetchadd.q/relaxed	r1, [r2]
; CHECK-ENCODING: encoding: [0xcb,0xf1,0xf0,0x04,0x12]

fetchxor.l/seqcst r1, [r2]
; CHECK-INST: fetchxor.l/seqcst	r1, [r2]
; CHECK-ENCODING: encoding: [0xcb,0xf1,0xe9,0x04,0x12]

cmpxchg.q/seqcst r1, r3, [r2]
; CHECK-INST: cmpxchg.q/seqcst	r1, r3, [r2]
; CHECK-ENCODING: encoding: [0xcb,0xf2,0x1c,0x13,0x12]
