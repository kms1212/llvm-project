...
; CHECK-LABEL: srl_imm:
; CHECK: lea.q 3, [[COUNT:r[0-9]+]]
; CHECK-NEXT: shr.l [[COUNT]], r0
; CHECK: ret
  %r = lshr i32 %a, 3
  ret i32 %r
}
...
; CHECK-LABEL: sra_imm:
; CHECK: lea.q 4, [[COUNT:r[0-9]+]]
; CHECK-NEXT: sar.l [[COUNT]], r0
; CHECK: ret
  %r = ashr i32 %a, 4
  ret i32 %r
}
