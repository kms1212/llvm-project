...
; OBJ: c7 e6 41 00{{.*}}fcopysign.s{{[ \t]+}}f1, f0, f0
...
; OBJ: c7 e6 c1 00{{.*}}fcopysign.d{{[ \t]+}}f1, f0, f0
...
; OBJ: c7 e2 0a 01{{.*}}fcvt.s{{[ \t]+}}r0, [[OBJ_SCALE:f[0-9]+]]
; OBJ: c2 81 10{{.*}}fscale.s{{[ \t]+}}[[OBJ_SCALE]], f0
...
; OBJ: cb b2 40 01 00{{.*}}fmovcr.d{{[ \t]+}}1, f0
  ret double -0.0
}
...
; OBJ: cb b2 40 02 00{{.*}}fmovcr.d{{[ \t]+}}2, f0
  ret double 1.0
}
...
; OBJ-LABEL: <pi_d>:
; OBJ: cb b2 40 10 00{{.*}}fmovcr.d{{[ \t]+}}16, f0
