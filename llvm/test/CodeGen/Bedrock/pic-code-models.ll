...
; SMALL-STATIC: R_BEDROCK_PCREL32S external_data 0x3
; SMALL-STATIC: R_BEDROCK_PCREL32S .data 0x3
; SMALL-STATIC: R_BEDROCK_TLS_OFFSET32S local_tls
; SMALL-STATIC: R_BEDROCK_TLSDESC_GOTPCREL32S external_tls 0x3
...
; HIGH: R_BEDROCK_PCREL32S .data 0x3
...
; SMALL-PIC: R_BEDROCK_GOTPCREL32S external_data 0x3
; SMALL-PIC: R_BEDROCK_PCREL32S .data 0x3
; SMALL-PIC: R_BEDROCK_TLSDESC_GOTPCREL32S local_tls 0x3
; SMALL-PIC: R_BEDROCK_TLSDESC_CALL local_tls
; SMALL-PIC: R_BEDROCK_TLSDESC_GOTPCREL32S external_tls 0x3
; SMALL-PIC: R_BEDROCK_TLSDESC_CALL external_tls
; SMALL-PIC: R_BEDROCK_PLT32S external_function

; MEDIUM-PIC: R_BEDROCK_GOTPCREL32S external_data 0x3
; MEDIUM-PIC: R_BEDROCK_GOTPCREL32S .data 0x3
; MEDIUM-PIC: R_BEDROCK_TLSDESC_GOTPCREL32S local_tls 0x3
; MEDIUM-PIC: R_BEDROCK_TLSDESC_GOTPCREL32S external_tls 0x3
; MEDIUM-PIC: R_BEDROCK_PLT32S external_function

; LARGE-PIC: R_BEDROCK_GOTPCREL64 external_data 0x3
; LARGE-PIC: R_BEDROCK_PCREL64 .data 0x3
; LARGE-PIC: R_BEDROCK_TLSDESC_GOTPCREL64 local_tls 0x3
; LARGE-PIC: R_BEDROCK_TLSDESC_CALL local_tls
; LARGE-PIC: R_BEDROCK_TLSDESC_GOTPCREL64 external_tls 0x3
